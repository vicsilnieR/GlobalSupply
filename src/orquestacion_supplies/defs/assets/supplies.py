...
from orquestacion_supplies.defs.assets.constants import KAGGLE_URL
...
def init_GlobalSupply_history(database: DuckDBResource) -> None:
    ...
    query = f"""
        CREATE OR REPLACE TABLE supplies_history AS
...
def new_GlobalSupply_prediction(
    ...
    repo_name = "vicsilnieR/GlobalSupply"
    branch = "main"
    github_path = f"datos/daily_supplies/supplies_to_predict_{date_sim_today}.parquet"

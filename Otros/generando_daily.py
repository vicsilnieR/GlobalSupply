...
#No ejecutar este script, los datos que usa ya no están en la carpeta.
#Se empleó una sola vez para generar los datos ficticios de envíos diarios
#Se ha mantenido para poder ver como se hizo

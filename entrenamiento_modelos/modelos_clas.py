...
#Dirección de mi carpeta actual
carpeta_actual = os.path.dirname(os.path.abspath(__file__))
# ".." para subir un nivel respecto a la carpeta actual (raiz) y después modelos/modelos_clas
directorio_modelos = os.path.join(carpeta_actual, "..", "modelos", "modelos_clasificacion")
